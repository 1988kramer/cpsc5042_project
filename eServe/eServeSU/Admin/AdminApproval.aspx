<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="AdminApproval.aspx.cs" Inherits="eServeSU.AdminApproval" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="glyphicon-sort-by-alphabet">
        ...
        <div>
            <div class="col-xs-3">
                <asp:Button ID="btnApproval" runat="server" Text="Approve this Opportunity" OnClick="btnApproval_Click"></asp:Button>
